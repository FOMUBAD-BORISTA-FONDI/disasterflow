...
const Report = ({ navigation }) => {
  ...
  const handleSendReport = () => {
    ...
    console.log('Sending Report...', { casualties, location, incidentPhoto, selectedOption });
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        {/* Radio Buttons */}
        <Text style={styles.label}>Are there any Casualties</Text>
...
//   const handleSendReport = () => {
//     // Implement logic to send the report
//     console.log('Sending Report...', { casualties, location, incidentPhoto });
//     // Additional logic, e.g., API calls, can be added here
//   };
